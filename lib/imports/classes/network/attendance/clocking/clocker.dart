...
class AttendanceClockerClockingAttendanceNetwork {
  static Future<Object> clockIn(
    int attendanceId, {
    ...
    try {
      ...
      var url = Uri.parse(
          "${apiBaseUrlFunctions(CLOCK_IN_MEMBER_CLOCKING_ATTENDANCE_SCHEDULES_API_ENDPOINTS)}/$attendanceId");
  ...
  static Future<Object> clockOut(
    ...
    try {
      ...
      var url = Uri.parse(
          "${apiBaseUrlFunctions(CLOCK_OUT_MEMBER_CLOCKING_ATTENDANCE_SCHEDULES_API_ENDPOINTS)}/$attendanceId");
      var request = http.Request('PATCH', url);
