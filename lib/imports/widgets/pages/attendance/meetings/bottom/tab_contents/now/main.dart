...
class TabContentNowBottomMeetingsPageSettingsWidget extends StatefulWidget {
  const TabContentNowBottomMeetingsPageSettingsWidget({
    Key? key,
  }) : super(key: key);

  @override
  State<TabContentNowBottomMeetingsPageSettingsWidget> createState() =>
      _TabContentNowBottomMeetingsPageSettingsWidgetState();
}

class _TabContentNowBottomMeetingsPageSettingsWidgetState
    extends State<TabContentNowBottomMeetingsPageSettingsWidget> {
  ...
  void initState() {
    ...
    meetingsDataTableSource = MeetingsDataTableSource(
      Provider.of<AttendanceMeetingNowDataTableViewModel>(
        context,
        listen: false,
      ),
      context: context,
  ...
  Widget build(BuildContext context) {
    ...
    // AttendanceMeetingNowDataTableViewModel meetingDatabaseViewModel =
    //     context.watch<AttendanceMeetingNowDataTableViewModel>();
    if (tabInfo == null) {
      return const Center(
