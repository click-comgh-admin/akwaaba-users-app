...
class AttendanceScheduleFullModelAdapter
    extends TypeAdapter<AttendanceScheduleFullModel> {
  @override
  final int typeId = 10;

  @override
  AttendanceScheduleFullModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return AttendanceScheduleFullModel(
      id: fields[0] as int?,
      type: fields[1] as int?,
      memberType: fields[2] as int?,
      name: fields[3] as String?,
      clientId: fields[4] as ClientIdModel?,
      branchId: fields[5] as BranchIdModel?,
      memberCategoryId: fields[6] as MemberCategoryIdModel?,
  ...
  @override
  void write(BinaryWriter writer, AttendanceScheduleFullModel obj) {
    writer
      ..writeByte(25)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is AttendanceScheduleFullModelAdapter &&
