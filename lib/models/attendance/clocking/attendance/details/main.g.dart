...
class AttendanceClockingAttendanceDetailsModelAdapter
    extends TypeAdapter<AttendanceClockingAttendanceDetailsModel> {
  @override
  final int typeId = 21;

  @override
  AttendanceClockingAttendanceDetailsModel read(BinaryReader reader) {
    ...
    return AttendanceClockingAttendanceDetailsModel(
      ...
      clockingMethodName: fields[13] as String?,
    );
  }

  @override
  void write(
      BinaryWriter writer, AttendanceClockingAttendanceDetailsModel obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is AttendanceClockingAttendanceDetailsModelAdapter &&
