...
class ClientIdModel {
  ...
  DateTime? updateDate;
  @HiveField(25)
  CountryInfoLocationModel? countryInfo;

  factory ClientIdModel.fromJson(Map<String, dynamic> json) {
    List<dynamic> countryInfos = json["countryInfo"];
    CountryInfoLocationModel? countryInfo = countryInfos.isNotEmpty
        ? CountryInfoLocationModel.fromJson(countryInfos.first)
        : null;
